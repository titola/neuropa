...
the omertà and the Smart Italy [2].
...
conduction filter based on the figure 4 in [5]. This type of signal
...
formula and the amplitude factors of the figure 4 in [5]:
...
50 Hz, the nominal frequency of the electrical grid in Italy [6], for
example:
...
[6] Coincidences: a three phase meter broken the last year during the
