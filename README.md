...
the omertà and the Smart Italy [3].
...
Caribbean crickets [4] obtained from [5] in the approximation of a
...
conduction filter based on the figure 4 in [6]. This type of signal
...
formula and the amplitude factors of the figure 4 in [6]:
...
50 Hz, the nominal frequency of the electrical grid in Italy [7], for
example:
...
In the filtered pulses obtained from the published sound file [5], the
...
the temperature rises of 5e-6 °C [8]. The rapid thermal expansion produces
...
[4] Caribbean crickets: [Recording of "sonic attacks" on U.S. diplomats in Cuba spectrally matches the echoing call of a Caribbean cricket (biorxiv.org)](https://www.biorxiv.org/content/10.1101/510834v1)
...
[7] Coincidences: a three phase meter broken the last year during the
